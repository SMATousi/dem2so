...
#     rgb_dir = '/home/macula/SMATousi/Gullies/ground_truth/google_api/training_process/DEM2SO/New_Data/rgb'
    ...
    model = ChainedUnets(resnet_output_size=(8, 8), 
    ...
    # )
    training_dataloader, validation_dataloader = accelerator.prepare(train_loader, 
                                                                     val_loader)
    ...
    for epoch in range(epochs):
        ...
        for i, batch in enumerate(tqdm(training_dataloader)):
            ...
            all_predictions = accelerator.gather(concatenated_outputs)
